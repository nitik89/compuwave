                  ...
                  <div class="row justify-content-center my-auto">
                      <div class="col-md-8 col-10 my-5">
                          <div class="row justify-content-center px-3 mb-3">
                             <img id="logo" src="https://yt3.ggpht.com/ytc/AAUvwnj2aypY6wsl3foroDaK1dBGFk42ZhLY4GCm2tog=s900-c-k-c0x00ffffff-no-rj" alt="img"/> </div>
        ...
        placeholder="Password"/> </div>
              ...
              <div class="card card2">
                  <div class="my-auto mx-md-5 px-md-5 right">
                      <h3 class="text-white">We are more than just a company</h3> <small class="text-white"> Society enables collaboration knowledge ,sharing,career environment and skill development across all engineering discipline towards a goal of helping to students to benefit lives and livelihood.</small>
                  </div>
              </div>
          </div>
      </div>
